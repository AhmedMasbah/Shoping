...
if (isset($_POST['id'])) {
  $exitCatigorie = new CatigorieController();
  $categorie = $exitCatigorie->getOneCategorie();
} else {
  header('Location: ../view/Catigorie.php');
}
if (isset($_POST['submit'])) {
  $exitCatigorie = new CatigorieController();
  $exitCatigorie->updateCategorie();
}
?>
<!DOCTYPE html>
<!--
                  ...
                  <form action="" method="POST">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="libelle" placeholder="Nom Article" value="<?php echo $categorie->libelle; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="date_creation" placeholder="Date Creation" value="<?php echo $categorie->date_creation; ?>">
                      </div>
                      <input type="hidden" name="id" value="<?php echo $categorie->id; ?>">
                    </div>
                    <!-- /.card-body -->
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" name="submit" style="float: right;">Modifier</button>
                    </div>
                  </form>
                </div>
                <!-- /.card -->
