  ...
  <div class="content-wrapper">
    ...
    <?php
       if(isset($_POST['Ajouter'])){
         $NewArticle= new ProduitController();
         $NewArticle->AddProduct();
         }
     ?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                 <!--______________________________forms ajouter Produits_____________________________________-->
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form  method="POST" enctype="multipart/form-data">
                          ...
                          <div class="mb-3">
                            <label  class="form-label">Qontite</label>
                            <input type="number" min="1" class="form-control" name="qte" required>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr >
                   ...
                   <td><img style="width: 70px;" src="../ImageArticle/<?= $produit['image'] ?>" alt="<?= $produit['Nom'] ?>"></td>
                    
                   <td style=" width: 40px ; text-align: center;">
                      <form action="editProduct.php" method="POST" style="  width: 45px; " >
                          <input type="hidden" name="id_product" value="<?= $produit['id'] ?>">
                          <button type="submit" class="btn btn-warning"><i class="fa fa-edit"></i></button>
                      </form>
                    </dt>
                      <td style=" width: 40px ; text-align: center;">
                      <form action="deletProduct.php" method="POST" style="  width: 45px; ">
                          <input type="hidden" name="id_product" value="<?= $produit['id'] ?>">
